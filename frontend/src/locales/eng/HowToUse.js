export const HowToUse = {
  ...
  ideSection: {
    ...
    description:
      "Idensyra is built with Wails and comes with a built-in Go runtime and pre-installed Insyra, allowing you to focus on data analysis tasks.",
    downloadButton: {
  ...
  quickLinks: {
    ...
    description:
      "Ready to start using Insyra? Interact with AI through online chat or MCP server for instant help.",
    chat: {
      text: "Chat with AI",
