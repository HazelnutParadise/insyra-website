export const zhTW = {
        ...
        featureItemSection: {
            ...
            features: {
                ...
                feature3: {
                    ...
                    learnMore: '了解 <strong>plot</strong> 與 <strong>gplot</strong> 套件',
                },
                feature4: {
                    id: 4,
                    title: '與 Python 整合',
                ...
                feature5: {
                    ...
                    learnMore: '發掘 <strong>Idensyra</strong>',
                },
            },
        },
    },
    AboutInsyra: {
        title: '什麼是 Insyra',
        description: 'Insyra 是一個專為效能和彈性設計的數據分析工具，它與 Python 無縫整合，讓您能夠輕鬆進行強大的資料處理和分析。',
    },
};
